...
Also read the historical analysis data we used to derive the strategy:
- The valuation database schema at /home/ubuntu/projects/quant.maftia.tech/engines/valuation/database/metrics.db
