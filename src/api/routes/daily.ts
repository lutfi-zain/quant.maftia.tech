...
dailyRouter.get("/", (c) => {
    ...
    SELECT 
      ...
      u.sdca_multiplier, u.sdca_phase, u.sdca_action, u.sdca_confidence,
      u.price_ma200_ratio, u.ath_drawdown,
  ...
  `;
	...
	const data = rows.map((row: any) => ({
		...
		sdca_multiplier: row.sdca_multiplier,
		sdca_phase: row.sdca_phase,
		sdca_action: row.sdca_action,
		sdca_confidence: row.sdca_confidence,
		price_ma200_ratio: row.price_ma200_ratio,
		ath_drawdown: row.ath_drawdown,
		valuation_composite: {
