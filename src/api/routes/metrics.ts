...
> = {
  aviv_ratio: { t_minus_2: 2.0, t_minus_1: 1.0, t_zero: null, t_plus_1: -1.0, t_plus_2: -2.0 },
  aviv_nupl: { t_minus_2: 0.5, t_minus_1: 0.3, t_zero: null, t_plus_1: -0.3, t_plus_2: -0.6 },
  cvdd_ratio: { t_minus_2: null, t_minus_1: null, t_zero: null, t_plus_1: 1.6, t_plus_2: 1.3 },
  mvrv_z: { t_minus_2: 6.65, t_minus_1: 4.6, t_zero: null, t_plus_1: 0.17, t_plus_2: 0.15 },
  lth_sth_sopr_ratio: { t_minus_2: 6.9, t_minus_1: 3.2, t_zero: null, t_plus_1: 0.99, t_plus_2: 0.73 },
  terminal_price_ratio: { t_minus_2: 0.17, t_minus_1: 0.25, t_zero: null, t_plus_1: 0.75, t_plus_2: 1.0 },
  unrealized_sell_risk: { t_minus_2: 2.2, t_minus_1: 1.8, t_zero: null, t_plus_1: null, t_plus_2: null },
  sharpe_ratio_52w: { t_minus_2: 53.0, t_minus_1: 42.0, t_zero: null, t_plus_1: -10.0, t_plus_2: -20.0 },
  pi_cycle_top: { t_minus_2: 0.95, t_minus_1: 0.7, t_zero: null, t_plus_1: 0.45, t_plus_2: 0.35 },
  vpli: { t_minus_2: 80.0, t_minus_1: 70.0, t_zero: null, t_plus_1: 50.0, t_plus_2: 45.0 },
  risk_metrics: { t_minus_2: 0.85, t_minus_1: 0.75, t_zero: null, t_plus_1: 0.33, t_plus_2: 0.13 },
  dvrsi: { t_minus_2: 73.0, t_minus_1: 65.0, t_zero: null, t_plus_1: 50.0, t_plus_2: 42.0 },
  williams_r: { t_minus_2: null, t_minus_1: null, t_zero: null, t_plus_1: -70.0, t_plus_2: -80.0 },
  two_year_ma: { t_minus_2: 4.2, t_minus_1: 3.0, t_zero: null, t_plus_1: 1.0, t_plus_2: 0.7 },
  ahr999: { t_minus_2: 5.47, t_minus_1: 2.9, t_zero: null, t_plus_1: 0.7, t_plus_2: 0.45 },
  fear_greed_og: { t_minus_2: 70.0, t_minus_1: 60.0, t_zero: null, t_plus_1: 50.0, t_plus_2: 30.0 },
  fear_greed_cmc: { t_minus_2: 80.0, t_minus_1: 60.0, t_zero: null, t_plus_1: 40.0, t_plus_2: 20.0 },
}
...
metricsRouter.get('/:metric_name/config', (c) => {
  try {
    ...
    const row = subsystemDb
      .prepare('SELECT t_minus_2, t_minus_1, t_zero, t_plus_1, t_plus_2 FROM metric_config WHERE metric_name = ?')
