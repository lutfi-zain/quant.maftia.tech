...
## Purpose
Defines requirements for the responsive React 19 + Vite single-page financial terminal architecture, 85px right Y-axis width locking across chart containers, and real-time vertical crosshair synchronization across subplots.
