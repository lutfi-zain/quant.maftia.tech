...
## Purpose
Defines requirements for canonical Bitcoin market data ingestion into `MasterOHLCV`, SQLite Write-Ahead Logging (WAL) concurrency enforcement across all database files, and zero lookahead bias via causal filtering.
