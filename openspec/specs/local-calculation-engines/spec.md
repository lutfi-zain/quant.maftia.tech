...
Defines the directory structure and path resolution for the quantitative calculation engines (valuation, LTTD, MTTD, ichimoku) that run as part of the daily pipeline.
## Requirements
