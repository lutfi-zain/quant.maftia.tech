			...
			>
				...
				>
					...
					>
						...
						>
							MAFTIA QUANT v2.0 · TELEMETRY BOOTSTRAP
						</span>
					</div>
					<div
						style={{
	...
	if (error) {
		return (
			...
			>
				<div className="terminal-scanline" />
				<div
					className="glass-card glow-danger"
					style={{
						padding: "36px",
						maxWidth: "520px",
						width: "90%",
				...
				>
					...
					>
						Ensure the Unified API Gateway (`src/api/index.ts`) is running on
						port `:8910` (`http://0.0.0.0:8910`) and SQLite WAL file locks are
						released.
					</div>
					<button
						onClick={refreshData}
