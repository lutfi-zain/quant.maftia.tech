...
interface AppLayoutProps {
	children: (
		activeTab: ActiveTab,
		onSelectStudio: (studio: ActiveTab) => void,
	) => React.ReactNode;
				...
				{!isMobile && (
					...
					>
						<div>
							...
							>
								Unified quantitative consensus & interlocking defense metrics ·
								api.quant.maftia.tech:8910
							</p>
						</div>
							...
							<div className={`sync-badge ${hasBehind ? "behind" : "current"}`}>
								{hasBehind ? (
									<>
										...
										<span>
											{syncGap.gapDays} day{syncGap.gapDays !== 1 ? "s" : ""}{" "}
											behind
										</span>
									</>
								) : syncGap.clientDate ? (
